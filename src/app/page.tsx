...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-24">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm font-medium mb-8">
            ...
            Intelligent GitHub Analytics
          </div>
          
          <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight" style={{ fontFamily: 'var(--font-fjalla-one)' }}>
            <span className="text-white">Automate your</span>
            <br />
            <span className="text-emerald-400">GitHub workflow</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center px-6 py-3 bg-gray-800 hover:bg-gray-700 text-white rounded-lg font-medium transition-colors border border-gray-700"
            >
      ...
      {/* Features Section */}
      <div id="features" className="py-24 border-t border-gray-800">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4" style={{ fontFamily: 'var(--font-fjalla-one)' }}>
              Everything you need
            </h2>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Comprehensive tools to monitor, analyze, and optimize your GitHub repositories.
            </p>
          </div>
      ...
      <div className="py-24 border-t border-gray-800">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          {!session && (
            <button
              onClick={handleOpenModal}
              className="inline-flex items-center px-8 py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-lg font-medium transition-colors"
            >
              Get Started Free
        ...
        >
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 max-w-md w-full">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">Sign in to GitFort</h3>
              <p className="text-gray-400 mb-8">Connect your GitHub account to get started</p>
              
              <button
                onClick={handleLogin}
                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-6 rounded-lg font-medium transition-colors mb-4"
              >
